...
|[secure-action-inputs](https://github.com/devops-actions/secure-action-inputs)|[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/devops-actions/secure-action-inputs/badge)](https://api.securityscorecards.dev/projects/github.com/devops-actions/secure-action-inputs)|
<!-- OSSF-SCORECARD-END -->
